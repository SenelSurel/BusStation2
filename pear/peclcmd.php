...
if ('C:\Users\senel.surel\PhpstormProjects\BusStation2\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('C:\Users\senel.surel\PhpstormProjects\BusStation2\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
