...
FOR %%x IN ("C:\Users\senel.surel\PhpstormProjects\BusStation2\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\Users\senel.surel\PhpstormProjects\BusStation2\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\Users\senel.surel\PhpstormProjects\BusStation2"
