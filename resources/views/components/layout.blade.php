...
<body class="font-sans antialiased text-black flex flex-col min-h-screen z-40" style="
        background-image:
            linear-gradient(rgba(0,0,0,0.25), rgba(0,0,0,0.25)),
            url('/frontend/images/busback.jpg');
            ...
            <div class="relative flex h-16 items-center justify-between">
                ...
                <div class="relative inline-block text-left">
                    <div class="flex space-x-5">
                        ...
                        <button type="button"
                            class=" self-center inline-flex w-full justify-center gap-x-1.5 rounded-md text-white px-3 py-2 text-sm font-semibold ring-1 shadow-xs hover:bg-gray-500/20  ring-gray-300 ring-inset align-baseline"
                    ...
                    <div class="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white ring-1 shadow-lg ring-black/5 focus:outline-hidden transform opacity-0 scale-95 transition-all duration-200 ease-in-out"
    ...
    <footer class="py-16 text-center text-sm text-white dark:text-white/70 bg-gray-800 w-full">
        ...
        <ul class="flex justify-around space-x-5 items-center my-8">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        fetch(apiEndpoint)
            ...
            .catch(error => console.error("Currency exchange rates could not be retrieved.:", error));
    });
    ...
    function convertPrice(currency) {
        ...
        if (!priceElements.length) {
            console.error("Price elements could not be found!");
            return;
        }
        ...
        priceElements.forEach(element => {
            ...
            if (isNaN(basePrice)) {
                console.error("Ticket prices are invalid:", element.id);
                return;
            }
