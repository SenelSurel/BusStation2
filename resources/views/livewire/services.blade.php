...
<div class="flex flex-col w-full bg-gray-300/20 backdrop-blur-[4px] justify-start space-y-4 shadow-black/60 md:flex-row md:space-x-6 md:my-12 my-8 p-4 rounded-xl text-white">
    <div>
